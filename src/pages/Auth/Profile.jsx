              ...
              <CardBody className="px-8">
                ...
                <form action="" onSubmit={handleSubmit(onSubmit)}>
                  <div className="pb-6 w-[24rem] flex flex-col">
                    ...
                    >
                      {provider ? "Account not need password" : " Save changes"}
                    </button>
                  </div>
                </form>
              </CardBody>
              ...
              <CardBody className="px-8">
                ...
                <div className="pb-6">
                  ...
                  <p>
                    ...
                    collect from you and how we use it, and that you should have
                    meaningful control over both. Our Privacy Policy provides
                    information on the processing of personal data by Meister
                    obtained in connection with a visit to our websites, use of
                    our community platform or use of our web-services and mobile
                    applications. Whenever significant changes are made to the
                    Privacy Policy, we will post a notice on our websites for a
                    period of 30 days.
                  </p>
                  ...
                  <p>
                    ...
                    with our services, and consequently what our liability is to
                    you.
                  </p>
                </div>
              </CardBody>
